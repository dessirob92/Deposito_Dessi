...
/*Trova tutti i clienti nella tabella customer il cui nome inizia con la lettera "A" 
e il cognome finisce con la lettera "S"*/
select *
from customer 
where first_name like 'A%'
and last_name like '%S';

/*Seleziona i film che hanno una durata (length) superiore a 150 minuti 
e un costo di noleggio (rental_rate) inferiore a 1.00$*/
select *
from film
where length > 150
